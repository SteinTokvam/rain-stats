...
import { addTotalRain, addRainData, addRainDataFiltered, resetRainData } from '../../actions/Rain';
    ...
    return(
        <div className="Dashboard">
            ...
            <>
                ...
                <Button onClick={() => updateRainData()} variant="text" style={{float: 'right'}}><svg width="64" height="64" viewBox="0 0 2048 2048" xmlns="http://www.w3.org/2000/svg">
